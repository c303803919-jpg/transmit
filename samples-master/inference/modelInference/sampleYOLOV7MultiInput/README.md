...
- [ATC 模型转换](https://www.hiascend.com/developer/courses/detail/1676866050056585217)                                                                                                                                                              
    该视频对于将原始模型转化为适配昇腾处理器的离线模型（*.om 文件）过程的讲解，帮助理解模型准备环节的原理与操作要点。                                                                                                                                                                                                                                                                                                       
 
- [AscendCL 模型推理基础流程](https://www.hiascend.com/developer/courses/detail/1679059522924683266)                                                                                                                                             
    该视频对于 AscendCL 模型推理基础流程的讲解，帮助理解本样例利用 YOLOV7 模型进行推理时，推理线程的运作原理和执行步骤。                                                                                                                         
    
- [AscendCL DVPP媒体数据处理](https://www.hiascend.com/developer/courses/detail/1679321450318241793)                                                                                                                                          
    该视频对于DVPP的讲解，介绍了DVPP中的 图片或视频 进行 解码、缩放 等操作，帮助理解样例中数据预处理环节的具体实现方式                                                                                                                                                           
    
- [AscendCL 视频目标检测应用开发课程](https://www.hiascend.com/developer/courses/detail/1795281013304832002)                                                                                                                                      
    该视频对于AscendCL 在视频目标检测应用开发方面知识的讲解，涵盖了从数据输入、预处理、模型推理到结果输出的完整流程。通过学习这门课程，能更好地理解本样例的整体设计和实现逻辑。    
