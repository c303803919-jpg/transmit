...
class sample_resnet_dvpp(object):
    ...
    def process_input(self, input_path, model_width, model_height):
        ...
        width, height= get_img_size(io.BytesIO(bytes_image))
        ...
        acl.media.dvpp_set_pic_desc_height_stride(self.resize_output_desc, resize_stride_height)
        acl.media.dvpp_set_pic_desc_width_stride(self.resize_output_desc, resize_stride_width)
