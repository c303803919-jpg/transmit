## Xlogy Custom Operator Example Explanation

This example demonstrates the implementation of the Xlogy operator using the Ascend C programming language, and provides end-to-end implementations for different operator invocation methods.

- [FrameworkLaunch](./FrameworkLaunch/README.en.md): Invokes the Xlogy custom operator using the framework.  
...
<table>
    ...
    <tr>
        <td rowspan='1'><a href="./FrameworkLaunch/README.en.md"> FrameworkLaunch</td><td><a href="./FrameworkLaunch/AclNNInvocation/README.en.md"> AclNNInvocation</td><td>Invokes the XlogyCustom operator using the aclnn method.</td>
    </tr>
</table>

## Operator Description

Returns 0 if x1 == 0, and x1 * log(x2) otherwise, elementwise.


## Operator Specification Description

<table>  
<tr><th align="center">Operator Type (OpType)</th><th colspan="4" align="center">Xlogy</th></tr>  
...
<tr><td rowspan="1" align="center">Kernel Function Name</td><td colspan="4" align="center">Xlogy</td></tr>
</table>
...
```
└── FrameworkLaunch    // Invokes the Xlogy custom operator using the framework.
```
