...
### 2. Running the aclnn Example
  ...
  - Enter the example directory
    ...
    ```bash
    cd ${git_clone_path}/samples/operator_contrib/TrilSample/FrameworkLaunch/AclNNInvocation
    ```
  - Example execution    
