## GlobalAvgPool Custom Operator Example Explanation
This example implements the GlobalAvgPool operator using the Ascend C programming language and provides end-to-end implementations for different operator invocation methods.

- [FrameworkLaunch](./FrameworkLaunch/README.en.md): Invokes the GlobalAvgPool custom operator using the framework.
...
<table>
    ...
    <tr>
        ...
        <td rowspan='1'><a href="./FrameworkLaunch/README.en.md"> FrameworkLaunch</td><td><a href="./FrameworkLaunch/AclNNInvocation/README.en.md"> AclNNInvocation</td><td>Invokes the GlobalAvgPool operator using the aclnn method.</td>
    </tr>
</table>

## Operator Description
Computes the GlobalAvgPool product of two tensors along a given dimension.

## Operator Specification Description
<table>
    <tr>
        <th align="center">Operator Type (OpType)</th><th colspan="5" align="center">GlobalAvgPool</th>
    </tr>
    <tr>
        ...
        <tr><td rowspan="1" align="center">Operator Input</td><td align="center">x</td><td align="center">-</td><td align="center">float32, float16</td><td align="center">ND</td><td align="center">\</td>
    </tr>
        <tr><td rowspan="1" align="center">Operator Output</td><td align="center">y</td><td align="center">-</td><td align="center">float32, float16</td><td align="center">ND</td><td align="center">\</td>
    </tr>
    <tr>
        <td rowspan="1" align="center">Kernel Function Name</td><td colspan="5" align="center">global_avg_pool</td></td>
    </tr>
</table>
...
```
└── FrameworkLaunch    // Project for invoking the GlobalAvgPool custom operator using the framework.
```
