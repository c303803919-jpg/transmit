...
### 2. Running the aclnn Example
  ...
  - Enter the example directory
    ...
    ```bash
    cd ${git_clone_path}/samples/operator_contrib/TriuSample/FrameworkLaunch/AclNNInvocation
    ```
  - Example execution    
