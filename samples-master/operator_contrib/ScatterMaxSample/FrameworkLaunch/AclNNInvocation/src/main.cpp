...
OperatorDesc CreateOpDesc()
{
    ...
    std::vector<int64_t> shape_indices { 5};
    std::vector<int64_t> shape_updata { 5 };
    ...
    opDesc.AddInputTensorDesc(dataTypeIndices, shape_indices.size(), shape_indices.data(), format);
    opDesc.AddInputTensorDesc(dataTypeVar, shape_updata.size(), shape_updata.data(), format);
    return opDesc;
}
...
{
    size_t fileSize = 0;
    ReadFile("../input/input_var.bin", fileSize, runner.GetInputBuffer<void>(0), runner.GetInputSize(0));
