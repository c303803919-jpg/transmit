## Lerp Custom Operator Example Explanation
This example implements the Lerp operator using the Ascend C programming language and provides end-to-end implementations for different operator invocation methods.

- [FrameworkLaunch](./FrameworkLaunch/README.en.md): Invokes the Lerp custom operator using the framework.
...
<table>
    ...
    <tr>
        ...
        <td rowspan='1'><a href="./FrameworkLaunch/README.en.md"> FrameworkLaunch</td><td><a href="./FrameworkLaunch/AclNNInvocation/README.en.md"> AclNNInvocation</td><td>Invokes the Lerp operator using the aclnn method.</td>
    </tr>
</table>

## Operator Specification Description
<table>  
<tr><th align="center">Operator Type (OpType)</th><th colspan="5" align="center">Lerp</th></tr>  
...
<tr><td align="center">start</td><td align="center">-</td><td align="center">float32, float16</td><td align="center">ND</td><td align="center">\</td></tr>  
<tr><td align="center">end</td><td align="center">-</td><td align="center">float32, float16</td><td align="center">ND</td><td align="center">\</td></tr>  
<tr><td align="center">weight</td><td align="center">-</td><td align="center">float32, float16</td><td align="center">ND</td><td align="center">\</td></tr>  
...
<tr><td rowspan="1" align="center">Kernel Function Name</td><td colspan="5" align="center">lerp</td></tr>  
</table>
...
```
└── FrameworkLaunch    // Project for invoking the Lerp custom operator using the framework.
```
