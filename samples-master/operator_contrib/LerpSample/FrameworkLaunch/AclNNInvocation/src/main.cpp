...
bool SetInputData(OpRunner &runner)
{
    ...
    ReadFile("../input/input_start.bin", fileSize, runner.GetInputBuffer<void>(START_INDEX), runner.GetInputSize(START_INDEX));
    ReadFile("../input/input_end.bin", fileSize, runner.GetInputBuffer<void>(END_INDEX), runner.GetInputSize(END_INDEX));
    ReadFile("../input/input_weight.bin", fileSize, runner.GetInputBuffer<void>(WEIGHT_INDEX), runner.GetInputSize(WEIGHT_INDEX));
