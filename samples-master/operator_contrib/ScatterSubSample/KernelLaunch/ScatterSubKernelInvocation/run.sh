...
# rm -rf output/output_y.bin
python3 scripts/gen_data.py
(export LD_LIBRARY_PATH=${_ASCEND_INSTALL_PATH}/tools/simulator/${_SOC_VERSION}/lib:$LD_LIBRARY_PATH && ./${FILE_NAME}_${RUN_MODE})
# (export LD_LIBRARY_PATH=${_ASCEND_INSTALL_PATH}/tools/simulator/${_SOC_VERSION}/lib:$LD_LIBRARY_PATH && gdb --args ./${FILE_NAME}_${RUN_MODE})
if [ $? -ne 0 ]; then
