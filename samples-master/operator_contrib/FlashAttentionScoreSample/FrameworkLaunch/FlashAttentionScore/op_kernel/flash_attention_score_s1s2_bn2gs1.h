...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const FlashAttentionScoreTilingData *__restrict tiling, TPipe *tPipe);
...
protected:
    __aicore__ inline void InitInput(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                     ...
                                     __gm__ uint8_t *workspace, const FlashAttentionScoreTilingData *__restrict tiling, TPipe *tPipe);
...
FlashAttentionScoreS1s2Bn2gs1::Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                    __gm__ uint8_t *softmaxMax, __gm__ uint8_t *softmaxSum,
                                    __gm__ uint8_t *attentionOut, __gm__ uint8_t *workspace,
...
__aicore__ inline void
FlashAttentionScoreS1s2Bn2gs1::InitInput(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                         __gm__ uint8_t *softmaxMax, __gm__ uint8_t *softmaxSum,
                                         __gm__ uint8_t *attentionOut, __gm__ uint8_t *workspace,
                                         const FlashAttentionScoreTilingData *__restrict tiling,
                                         TPipe *tPipe)
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::InitBuffer()
{
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::ComputeConstexpr()
{
    // 计算轴的乘积
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::Process()
{
    // 确定核内切分起点
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::ComputeAxisIdx(int64_t multiCoreInnerIdx)
{
    // 计算轴的idx
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::WaitBmm1Result(SplitExtraInfo &extraInfo)
{
    this->bmm1.WaitIterateAll();
    this->bmm1.End();
}

__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::SetExtraInfo(SplitExtraInfo &extraInfo, int64_t taskId,
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::ComputeBmm1Tail(SplitExtraInfo &extraInfo)
{
...
template <typename T2, const MatmulConfig &MM_CFG>
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::IterateBmm1(SplitExtraInfo &extraInfo,
                                                                    matmul::Matmul<a1Type, b1Type, T2, bias1Type, MM_CFG> &bmm1)
{
...
template <typename T2, const MatmulConfig &MM_CFG>
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::Bmm1SetTensorA(SplitExtraInfo &extraInfo,
                                                                        matmul::Matmul<a1Type, b1Type, T2, bias1Type, MM_CFG> &bmm1)
{
    // 计算gm上的offset
...
template <typename T2, const MatmulConfig &MM_CFG>
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::SetBmm1TensorB(SplitExtraInfo &extraInfo,
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::ProcessVec1(SplitExtraInfo &extraInfo)
{
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::GetBmm1Result(SplitExtraInfo &extraInfo, LocalTensor<float> &bmm1ResUb,
                                                                    int64_t loopIdx)
{
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::SoftMaxCompute(SplitExtraInfo &extraInfo, LocalTensor<float> &srcTensor,
                                                                        int64_t loopIdx)
{
    uint32_t bmm1ResUbShape[] = {static_cast<uint32_t>(extraInfo.vec1S1RealSize),
                                 static_cast<uint32_t>(extraInfo.s2AlignedSize)};
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::WaitBmm2Result()
{
    this->bmm2.WaitIterateAll();
    this->bmm2.End();
}

__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::IterateBmm2(SplitExtraInfo &extraInfo)
{
    int64_t bOffset = 0;
    int64_t n2Offset = 0;
    int64_t s2Offset = 0;
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::ProcessVec2(SplitExtraInfo &extraInfo)
{
    // 获取缓存bmm2的计算结�?
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::Bmm2ResultMul(SplitExtraInfo &extraInfo, LocalTensor<float> &bmm2ResUb,
                                                            int64_t s1oIdx)
{
    pipe_barrier(PIPE_V);
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::Bmm2ResultDiv(SplitExtraInfo &extraInfo, int64_t s1oIdx)
{
    LocalTensor<float> bmm2ResUb = this->stage2TBuf.template Get<float>();
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::Bmm2DataCopyOut(SplitExtraInfo &extraInfo, int64_t s1oIdx,
...
__aicore__ inline void FlashAttentionScoreS1s2Bn2gs1::SoftmaxDataCopyOut(SplitExtraInfo &extraInfo, int64_t s1oIdx)
{
