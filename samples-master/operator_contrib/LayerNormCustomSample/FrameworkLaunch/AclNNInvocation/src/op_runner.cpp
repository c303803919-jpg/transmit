...
*/
#include "op_runner.h"
#include "aclnn_layer_norm_custom.h"
#include <limits>
#include <cassert>
...
bool OpRunner::RunOp()
{
	...
	auto ret = aclnnLayerNormCustomGetWorkspaceSize(inputTensor_[0], inputTensor_[1], inputTensor_[2],
	...
	INFO_LOG("Execute aclnnLayerNormCustomGetWorkspaceSize success, workspace size %lu", workspaceSize);
	...
	INFO_LOG("Execute aclnnLayerNormCustom success");
