...
#include "acl/acl.h"
#include "aclrtlaunch_greater_equal.h"
#else
...
int32_t main(int32_t argc, char* argv[])
{
    ...
    size_t inputByteSize = 1024 * sizeof(T);
    size_t outputByteSize = 1024 * sizeof(int8_t);
    ...
    ICPU_RUN_KF(greater_equal, blockDim, x1, x2, y, usrWorkSpace, *reinterpret_cast<SplitTilingData*>(tiling));
    ...
    ACLRT_LAUNCH_KERNEL(greater_equal)(blockDim, stream, x1_device, x2_device, y_device, workSpace_device, tiling);
