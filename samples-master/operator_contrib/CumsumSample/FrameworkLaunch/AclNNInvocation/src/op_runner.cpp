...
bool OpRunner::RunOp()
{
	...
	auto ret = aclnnCumsumGetWorkspaceSize(inputTensor_[0], inputTensor_[1], opDesc_->exclusive, opDesc_->reverse,
    ...
    ret = aclnnCumsum(workspace, workspaceSize, handle, stream);
