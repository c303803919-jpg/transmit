...
OperatorDesc CreateOpDesc()
{
    ...
    OperatorDesc opDesc;
    opDesc.minRadius = MIN_R;
    opDesc.maxRadius= MAX_R;
    opDesc.sampleNum = SN;
...
bool SetInputData(OpRunner &runner)
{
    ...
    constexpr int P0 = 0;
    constexpr int P1 = 1;
    ReadFile("../input/input_xyz.bin", fileSize, runner.GetInputBuffer<void>(P0), runner.GetInputSize(P0));
    ReadFile("../input/center_xyz.bin", fileSize, runner.GetInputBuffer<void>(P1), runner.GetInputSize(P1));
