...
| 硬件要求 | Atlas200DK | 摄像头样例仅在Atlas200DK上测试验证，产品说明请参考[硬件平台](https://ascend.huawei.com/zh/#/hardware/product) |
...
2. 模型转换。      
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    |  resnet18 | 手写汉字识别模型。  |  请参考[https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/resnet18/%20ATC_resnet18_caffe_AE](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/resnet18/%20ATC_resnet18_caffe_AE)目录中README.md下载原始模型章节下载模型和权重文件。 |
