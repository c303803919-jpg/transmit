...
2. 模型转换。       
    ...
    - 3.0.0版本       
        |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
        |---|---|---|
        |  cartoonization | 图片生成推理模型。  |  请参考[https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/cartoonization/ATC_cartoonization_tf_AE](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/cartoonization/ATC_cartoonization_tf_AE)目录中README.md下载原始模型章节的模型文件。 |
