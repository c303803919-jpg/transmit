...
3.  下载sample仓代码并上传至环境后，请先进入根目录下“cplusplus/level2_simple_inference/1_classification/vpc_resnet50_imagenet_classification”样例目录。
...
2.  编译代码。
    ...
    2.  请先进入根目录下“cplusplus/level2_simple_inference/1_classification/vpc_resnet50_imagenet_classification”样例目录。
