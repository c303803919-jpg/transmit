...
1.  下载sample仓代码并上传至环境后，请先进入根目录下“cplusplus/level2_simple_inference/0_data_process/batchcrop”样例目录。
...
2.  编译代码。
    ...
    2.  下载sample仓代码并上传至环境后，请先进入根目录下“cplusplus/level2_simple_inference/0_data_process/batchcrop”样例目录。
