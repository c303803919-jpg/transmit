...
aclError BatchNormTest(int64_t n, int64_t c, int64_t h, int64_t w)
{
    ...
    ACL_REQUIRES_OK(aclrtMalloc(&devInput, size_input, ACL_MEM_MALLOC_HUGE_FIRST));
    ACL_REQUIRES_OK(aclrtMalloc(&devInput_gamma, size_gamma, ACL_MEM_MALLOC_HUGE_FIRST));
    ACL_REQUIRES_OK(aclrtMalloc(&devInput_beta, size_beta, ACL_MEM_MALLOC_HUGE_FIRST));
    ACL_REQUIRES_OK(aclrtMalloc(&devOutput, size_output, ACL_MEM_MALLOC_HUGE_FIRST));
