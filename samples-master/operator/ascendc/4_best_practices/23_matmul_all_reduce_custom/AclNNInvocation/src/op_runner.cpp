...
#include "aclnn_matmul_all_reduce_custom.h"
#include "../../matmul_all_reduce_demo_def.h"
#include "common.h"
...
bool OpRunner::RunOp(std::string group, aclrtStream stream)
{
    ...
    auto ret = aclnnMatmulAllReduceCustomGetWorkspaceSize(inputTensor_[0], inputTensor_[1], bias, (char*)group.c_str(),
    ...
    ret = aclnnMatmulAllReduceCustom(workspace, workspaceSize, handle, stream);
    if (ret != ACL_SUCCESS) {
