...
#include "acl/acl.h"
#include "aclrtlaunch_reduce_min_custom.h"
#else
...
int32_t main(int32_t argc, char *argv[])
{
    ...
    ICPU_RUN_KF(reduce_min_custom, blockDim, inputGM, outputGM, syncGM); // use this macro for cpu debug
    ...
    ACLRT_LAUNCH_KERNEL(reduce_min_custom)(blockDim, stream, xDevice, zDevice, syncDevice);
