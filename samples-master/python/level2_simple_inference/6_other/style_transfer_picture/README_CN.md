...
2. 获取此应用中所需要的原始网络模型。
    |  **模型说明**  |  **模型下载路径**  |
    |---|---|
    | 基于GAN网络的模型。  |  请参考[https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/style_transfer](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/style_transfer)目录中README.md下载原始模型章节下载模型和权重文件。 |
