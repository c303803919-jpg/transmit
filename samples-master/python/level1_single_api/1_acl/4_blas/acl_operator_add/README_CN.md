...
1.  模型转换。
    ...
    2.  参见《[ATC学习向导](https://www.hiascend.com/document/detail/zh/canncommercial/800/devaids/devtools/atc/atlasatc_16_0001.html)》中的“环境搭建”章节中的ATC工具使用环境搭建，获取ATC工具并设置环境变量。
